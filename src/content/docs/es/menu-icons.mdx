---
title: "Íconos del menu"
description: "Configuración de los íconos del menu"
order: 5
---
...
Para personalizar los íconos del menu debe crear un archivo de tipo `JSON` y en él agregar la siguiente estructura:
...
> Estos SVGs deben llevar el atributo `fill="currentColor"` para que el color pueda adaptarse de manera correcta a los colores de la barra de título.

## Elementos del menú

<MenuIcon option="submenuIndicator" description="Es el ícono para los submenús." />
<MenuIcon option="checkbox" description="Es el ícono para los checkbox." />
<MenuIcon option="radioChecked" description="Es el ícono para los elementos de radio cuando este está seleccionado." />
<MenuIcon option="radioUnchecked" description="Es el ícono para los elementos de radio cuando no está seleccionado." />
...
<MenuIcon option="linux.minimize" description="Es el ícono para minimizar la ventana." />
<MenuIcon option="linux.maximize" description="Es el ícono para maximizar la ventana." />
<MenuIcon option="linux.restore" description="Es el ícono para restaurar la ventana." />
<MenuIcon option="linux.close" description="Es el ícono para cerrar la ventana." />

### Windows

<MenuIcon option="windows.minimize" description="Es el ícono para minimizar la ventana." />
<MenuIcon option="windows.maximize" description="Es el ícono para maximizar la ventana." />
<MenuIcon option="windows.restore" description="Es el ícono para restaurar la ventana." />
<MenuIcon option="windows.close" description="Es el ícono para cerrar la ventana." />
<br/>

> **Nota** Los íconos de la barra de título no son compatibles con macOS.